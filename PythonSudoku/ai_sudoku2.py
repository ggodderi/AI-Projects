"""
ai_sudoku2.py
A GUI Sudoku player using tkinter that follows Description2.txt requirements.
...
class SudokuGUI:
    ...
    def on_key(self, event):
        if not self.selected:
            return
        # Some keys (arrows, function keys) produce empty event.char; ignore them
        if not event.char:
            # Check for BackSpace/Delete via keysym
